...
with col2:
    ...
    # Form
    with st.form("phone_recovery_direct_form"):
        phone = st.text_input(
            "Phone number",
            placeholder="+60 12 345 6789",
            key="recovery_phone_direct_input"
        )
        ...
        if submitted:
            if not phone:
                ...
                if user:
                    # Store phone in session and move to security questions (full path)
                    st.session_state.recovery_phone = phone
                    st.success("Phone number verified! Proceeding to security questions...")
    ...
    st.markdown("""
        <div class="link-section">
            Still have your registered phone? <a href="/Password">Quick recovery</a>
        </div>
    """, unsafe_allow_html=True)
